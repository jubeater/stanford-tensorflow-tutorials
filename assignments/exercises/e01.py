...
x = tf.constant([29.05088806,  27.61298943,  31.19073486,  29.35532951, 
	30.97266006,  26.67541885,  38.08450317,  20.74983215, 34.94445419,  
	34.45999146,  29.06485367,  36.01657104, 27.88236427,  20.56035233,  
	30.20379066,  29.51215172, 33.71149445,  28.59134293,  36.05556488,  28.66994858])
shape = tf.shape(x)
#y = tf.fill(shape, 30.0)
...
limit = 7
delta = 1
ran = tf.range(start,limit,delta, dtype=tf.int32)
out = tf.diag(ran)
...
#	lambda: tf.reduce_mean(tf.square(tf.abs(x - y))), 
#	lambda: tf.reduce_sum(tf.abs(x - y)))
